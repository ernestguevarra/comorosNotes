...
{\centering \includegraphics[width=0.3\linewidth]{figures/h2} \includegraphics[width=0.3\linewidth]{figures/c2a} \includegraphics[width=0.3\linewidth]{figures/i9a} 

}

\caption{Example results mapping from RAM surveys conducted in Sierra Leone by UNICEF}\label{fig:sampleResults1}
\end{figure}
