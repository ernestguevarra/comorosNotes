...
```{r sampleResults1, echo = FALSE, eval = TRUE, fig.cap = "Example results mapping from RAM surveys conducted in Sierra Leone by UNICEF", fig.show = "hold", fig.align = "center", out.width = "30%"}
